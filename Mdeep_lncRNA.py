...
def mdeep_lncRNA(dataset, output):
...
parser = argparse.ArgumentParser(description="Mdeep-lncRNA: an alignment-free predictor for long non-coding RNAs identification by multimodal deep learning")
